        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sub_categorys_update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group mb-3">
                                ...
                                @foreach ($datas as $data)
                                  <option value="{{ $data->id }}" @foreach ($a as $tag1) @if ($datas->id == $tag1) selected  @endif  @endforeach>{{ $data->name }}</option>
                                @endforeach
                                </select>
                              </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="d-grid mx-auto">
                                ...
                                <a class="btn btn-primary  " href="{{ url('sub_categorys_manage/')}}" role="button">Back </a>
